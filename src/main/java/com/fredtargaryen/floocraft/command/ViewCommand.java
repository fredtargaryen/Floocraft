...
public class ViewCommand {
    ...
    private static int execute(CommandSource source, DimensionType type, String query) {
        ServerWorld world = DimensionManager.getWorld(source.getServer(), type, false, false);
