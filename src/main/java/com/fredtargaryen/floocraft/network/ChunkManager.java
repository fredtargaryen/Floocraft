...
public class ChunkManager extends ChunkTicketManager<PeekerTicket> {
    private static HashMap<EntityPeeker, SimpleTicket> tickets = new HashMap<>();
    ...
    public static boolean loadChunks(World world, BlockPos dest, EntityPeeker ep, EnumFacing direction) {
        ...
        ChunkTicketManager.Ticket t = ForgeChunkManager.requestTicket(FloocraftBase.instance, world, ForgeChunkManager.Type.ENTITY);
        if(t == null) {
            return false;
        }
        else {
