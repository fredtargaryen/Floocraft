...
public class FlooTorchBlock extends TorchBlock {
    ...
    public FlooTorchBlock() {
        super(ParticleTypes.FLAME, Block.Properties.of()
                .setId(ResourceKey.create(Registries.BLOCK, DataReference.getResourceLocation(FloocraftBlocks.FLOO_TORCH_RL)))
                .noCollission()
                .instabreak()
                .lightLevel(state -> 14)
    ...
    @Override
    public void entityInside(@Nonnull BlockState state, @Nonnull Level level, @Nonnull BlockPos pos, @Nonnull Entity entity, InsideBlockEffectApplier effectApplier) {
